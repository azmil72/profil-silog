...
class CompleteContentSeeder extends Seeder
{
    public function run()
    {
        ...
        $contents = [
            ...
            ['type' => 'hero', 'title' => 'Solusi Logistik Terdepan', 'subtitle' => 'Solusi terpercaya untuk kebutuhan logistik, konstruksi, dan distribusi di seluruh Indonesia.', 'image' => 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&h=600&fit=crop', 'order' => 1, 'is_active' => 1],
            ['type' => 'hero', 'title' => 'Konstruksi & Manufaktur Berkualitas', 'subtitle' => 'Membangun masa depan Indonesia dengan teknologi konstruksi modern dan proses manufaktur yang berkelanjutan.', 'image' => 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=800&h=600&fit=crop', 'order' => 2, 'is_active' => 1],
            ['type' => 'hero', 'title' => 'Jaringan Distribusi Nasional', 'subtitle' => 'Menjangkau seluruh nusantara dengan jaringan distribusi yang luas dan sistem manajemen yang terintegrasi.', 'image' => 'https://images.unsplash.com/photo-1494412651409-8963ce7935a7?w=800&h=600&fit=crop', 'order' => 3, 'is_active' => 1],
            ['type' => 'hero', 'title' => 'Inovasi & Teknologi Digital', 'subtitle' => 'Menggunakan teknologi terkini dalam setiap aspek operasional untuk memberikan pelayanan yang efisien dan berkelanjutan.', 'image' => 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=800&h=600&fit=crop', 'order' => 4, 'is_active' => 1],
