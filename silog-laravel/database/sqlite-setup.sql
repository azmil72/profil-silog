-- SQLite Database Setup for SILOG Website
-- Run this in Laravel: php artisan migrate:fresh --seed
...
-- Insert Services Content (3 items)
INSERT INTO contents (type, title, description, icon, `order`, is_active) VALUES
...
-- Insert Subsidiaries Content (4 items)
...
-- Insert Gallery Content (4 items)
